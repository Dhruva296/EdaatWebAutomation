...
//	}
	...
	public boolean ExistsCheck(String xpath) throws IOException {
		boolean bExists = false;
...
//							+ new Exception().getStackTrace()[0].getLineNumber() + "!" + WARNINGFontColorSuffix);
	...
	public void WebClick(String sEleXpath) throws Exception {
	...
	public String getText(String sEleXpath) throws Exception {
		String text = "";
		try {
			SetExecutionDelay();
			SetExecutionDelay();
	...
	public void VerifyValue(String ExpectedValue, String sEleXpath) throws Exception {
		if (ExpectedValue != "") {
