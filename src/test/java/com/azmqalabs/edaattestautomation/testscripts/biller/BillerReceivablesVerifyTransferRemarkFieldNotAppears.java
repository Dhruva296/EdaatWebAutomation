/**
*
* Test Script Name                      : BillerReceivablesVerifyTransferRemarkFieldNotAppears.
* Test Data Sheet                       : BillerReceTRfieldNotdisplay.
* Objective                             : Verify the field will not appear when there is no sub-biller selected .
* Version                               : 1.0
...
public class BillerReceivablesVerifyTransferRemarkFieldNotAppears {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceTRfieldNotdisplay";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesVerifyTransferRemarkFieldNotAppears(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.navigateToReceivableExportBiller(Log);     	        		        	
