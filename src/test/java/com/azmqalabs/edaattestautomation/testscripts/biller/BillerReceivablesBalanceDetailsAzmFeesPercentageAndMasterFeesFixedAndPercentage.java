...
public class BillerReceivablesBalanceDetailsAzmFeesPercentageAndMasterFeesFixedAndPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAzmFeesPerAndMasterFixPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesPercentageAndMasterFeesFixedAndPercentage(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesBalancePage.searchBasedOnContractNumber(testdatamap,Log);
