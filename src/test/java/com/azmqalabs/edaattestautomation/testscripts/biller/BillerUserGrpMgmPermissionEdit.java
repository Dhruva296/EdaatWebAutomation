	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerUserGroupManagementPage.naviagteGroupManagement(testdatamap,Log);
	        	...
	        	Pages.BillerUserGroupManagementPage.EditGroupPermission(testdatamap,Log);
	        	
	        	Pages.BillerUserGroupManagementPage.ViewGroupPermission(testdatamap,Log);
