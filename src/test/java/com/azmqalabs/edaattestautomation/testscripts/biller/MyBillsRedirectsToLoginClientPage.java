/**
*
* Test Script Name                      : MyBillsRedirectsToLoginClientPage.
* Test Data Sheet                       : MyBillsRedirectsToClientLogin.
* Objective                             : verify that clicking on inquire about invoice button redirects to the login client page .
* Version                               : 1.0
...
public class MyBillsRedirectsToLoginClientPage {
	
	// DECLARATION SECTION
	  static String TestDataTab="MyBillsRedirectsToClientLogin";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public MyBillsRedirectsToLoginClientPage(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.MyBillsPage.verifyRedirectsToTheLoginClientPage(testdatamap,Log);    	
