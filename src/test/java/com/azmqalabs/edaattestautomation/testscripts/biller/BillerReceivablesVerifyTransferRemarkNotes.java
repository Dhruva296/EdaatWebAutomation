	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            Pages.BillerReceivablesExportedbillsPage.navigateToCreateInvoicePage(Log);
	            
	            Pages.BillerReceivablesExportedbillsPage.verifyTransferNotesField(testdatamap,Log);
	            
	            Pages.BillerReceivablesExportedbillsPage.validateTransferNotes(testdatamap,Log);	           	       	
