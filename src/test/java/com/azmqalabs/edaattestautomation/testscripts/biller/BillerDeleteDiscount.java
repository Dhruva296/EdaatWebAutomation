...
public class BillerDeleteDiscount {
	...
	// DECLARATION SECTION
	  static String TestDataTab="BillerDeleteDiscount";  
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsDiscountPage.navigateToDisCountPage(Log);
	        	
	        	Pages.BillerSettingsDiscountPage.AddDiscount(testdatamap,Log);

	        	Pages.BillerSettingsDiscountPage.searchDiscount(testdatamap,Log);
	        
	        	Pages.BillerSettingsDiscountPage.DeleteDiscount(testdatamap,Log);
