...
public class BillerReceivablesBalanceDetailsAzmFeesFixedPercentageAndVisaFeesFixed {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAzmFeesFixPerAndVisaFix";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedPercentageAndVisaFeesFixed(Map<Object, Object> testdatamap){
