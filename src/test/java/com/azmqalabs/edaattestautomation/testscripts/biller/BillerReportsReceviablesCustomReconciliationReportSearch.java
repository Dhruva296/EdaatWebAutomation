/**
* Test Script Name  				 : BillerReportsReceviablesCustomReconciliationReportSearch.
*TestDataSheet                       : BillerCustomReportSearch
...
public class BillerReportsReceviablesCustomReconciliationReportSearch {

	// DECLARATION SECTION
	static String TestDataTab = "BillerCustomReportSearch";
	...
	public BillerReportsReceviablesCustomReconciliationReportSearch(Map<Object, Object> testdatamap) {
...
//	    @Parameters({ "username", "password" })
	...
	public void myTest() throws InterruptedException, Exception {
		try {
			...
			Pages.BillerReportsCustomReconciliationReportPage.verifySearchButton(testdatamap, Log);
