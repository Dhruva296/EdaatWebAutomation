...
public class BillerApprovedBillersMgmVerifyThatTransferRemarkFieldAppearsWhenBillerHasSubBiller {
	
	// DECLARATION SECTION
	  static String TestDataTab="BilApprovedBillersMgmTransField";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerApprovedBillersMgmVerifyThatTransferRemarkFieldAppearsWhenBillerHasSubBiller(Map<Object, Object> testdatamap){
