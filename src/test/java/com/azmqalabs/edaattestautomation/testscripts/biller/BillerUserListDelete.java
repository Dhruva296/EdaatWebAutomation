...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerUserMngUserListPage.AddUser(testdatamap,Log);
	        	
	        	Pages.BillerUserMngUserListPage.SearchUser(testdatamap,Log);
	        	
	        	Pages.BillerUserMngUserListPage.DeleteUser(testdatamap,Log);

	        	Pages.BillerUserMngUserListPage.verifyDeleteUserCheckbox(testdatamap,Log);
