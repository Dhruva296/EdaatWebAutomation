...
public class BillerSettingsBillsCancellationErrorMsg {
	...
	// DECLARATION SECTION
	  static String TestDataTab="BillerBillsCancellationUI";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsPage.NavigatetoSettingsBillsCancellation(Log);

	        	Pages.BillerSettingsPage.BillsCancelationErrorMessageValidation(testdatamap, Log);
