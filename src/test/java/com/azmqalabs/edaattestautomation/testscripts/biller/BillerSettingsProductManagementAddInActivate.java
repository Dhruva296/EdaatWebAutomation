	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsPage.navigateToProductManagement(Log);
	        	
	        	Pages.BillerSettingsPage.AddProduct(testdatamap,Log);

	        	Pages.BillerSettingsPage.SearchProduct(testdatamap,Log);

	        	Pages.BillerSettingsPage.verifyProdutToggleStatus(testdatamap,Log);
