...
public class BillerReceivablesExportContactPaymentMethodsVerification {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerExportContractPaymentMtd";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportContactPaymentMethodsVerification(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.verifyPaymentMethodsInInvoiceDetailsPage(testdatamap,Log);	        	
