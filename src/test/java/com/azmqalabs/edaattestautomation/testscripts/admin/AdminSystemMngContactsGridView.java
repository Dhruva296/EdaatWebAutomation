/**
*
* Test Script Name                   : AdminSystemMngContactsGridView
* Test Data Sheet                    : AdminContactsView
* Objective                          : Verify to View the GridView of Contracts under system management module. 
* Version                            : 1.0
...
public class AdminSystemMngContactsGridView {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminContactsView";
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMngContactsGridView(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMangementContactsPage.VerifyContactsGridView(testdatamap,Log);
