/**
*
* Test Script Name                   : AdminSystemMgmPaymentProviderPageIsAdded 
* Test data sheet Name               : AdminSystemMgmPaymentProviderPage
* Objective                          : Verify new "Payment Provider management" page is added under System Management module
* Version                            : 1.0
...
public class AdminSystemMgmPaymentProviderPageIsAdded {

	// DECLARATION SECTION
	static String TestDataTab="AdminSystemMgmPaymentProvPage";  
	...
	public AdminSystemMgmPaymentProviderPageIsAdded(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSystemMangement.verifyPaymentProviderManagementPageIsDisplayed(testdatamap,Log);
