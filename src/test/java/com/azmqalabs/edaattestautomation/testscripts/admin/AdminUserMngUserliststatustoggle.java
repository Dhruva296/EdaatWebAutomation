/**
* Test Script Name                   : AdminUserMngUserliststatustoggle
* Test Data Sheet                    : AdminUserListStatustoggle
* Objective                          : Verify the Status toggle under User Management Module
* Version                            : 1.0
...
public class AdminUserMngUserliststatustoggle {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminUserListStatustoggle";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUserMngUserliststatustoggle(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngUserListPage.Verifystatustoggle(testdatamap,Log);
