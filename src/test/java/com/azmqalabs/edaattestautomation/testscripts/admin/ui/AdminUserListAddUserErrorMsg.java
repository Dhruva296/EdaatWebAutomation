/**
* Test Script Name                   : AdminUserListAddUserErrorMsg
* Test Data Sheet Name				 : AdminUserListAdd
* Objective                          : 1)Verify Add User Error Message under User Management module
* Version                            : 1.0
...
public class AdminUserListAddUserErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminUserListAdd";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUserListAddUserErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngUserListPage.verifyAddUserErrorMsg(testdatamap,Log);
