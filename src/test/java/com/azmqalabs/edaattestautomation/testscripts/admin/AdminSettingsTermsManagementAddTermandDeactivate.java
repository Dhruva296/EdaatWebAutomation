/**
* Test Script Name                      : AdminSettingsTermsManagementAddTermandDeactivate
* Objective                             : Verify to add product & De-Activate/Verify status toggel Under Settings Module
* Version                               : 1.0
...
public class AdminSettingsTermsManagementAddTermandDeactivate {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminAddTermDect";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsTermsManagementAddTermandDeactivate(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingTermsManagementPage.AddTermAndDeActivate(testdatamap,Log);
