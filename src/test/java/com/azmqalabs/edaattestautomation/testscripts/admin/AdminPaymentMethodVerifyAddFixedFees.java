/**
*
* Test Script Name                   : AdminPaymentMethodVerifyAddFixedFees
* Test Data Sheet Name				 : AdminVerifyAddFixedFees
* Objective                          : Verify to Add Fixed Fees to a Payment method 
* Version                            : 1.0
...
public class AdminPaymentMethodVerifyAddFixedFees {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminVerifyAddFixedFees";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminPaymentMethodVerifyAddFixedFees(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            Pages.AdminSystemMangement.VerifyPaymentMethodsAddFixedFees(testdatamap,Log);       	
