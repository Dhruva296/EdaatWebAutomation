/**
*
* Test Script Name                   : AdminSystemMgmIndividualClientAccountSettingButton 
* Test data sheet Name               : AdminSysMgmIndSettingButton
...
public class AdminSystemMgmIndividualClientAccountSettingButton {

	// DECLARATION SECTION
	static String TestDataTab="AdminSysMgmIndSettingButton";  
	...
	public AdminSystemMgmIndividualClientAccountSettingButton(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSystemMgmIndividualClientPage.VerifyAccountSettingButton(testdatamap,Log);
