/**
*
* Test Script Name                   : AdminSettingsProductManagementSearch 
* TestData Sheet Name                : AdminSearchProduct
...
* Pre-Conditions                     : 1)Admin Logged in with valid Credentials. 
                                       2)Product details should be present.
* Epic Details                       : N/A
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsPage.navigateProduct(Log);
	         	...
	         	Pages.AdminSettingsPage.verifySearchFunctionality(testdatamap,Log);
