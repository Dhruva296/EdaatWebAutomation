/**
* Test Script Name                   : AdminSearchCatgory
* Test Data Sheet Name				 : AdminSearchCategory
* Objective                          : Verify search functionality under System Management module 
* Version                            : 1.0
...
* Pre-Conditions                     : 1)Valid Admin Login Credentials
									 : 2)Product category should be present.
* Epic Details                       : N/A
	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMangement.SearchCategory(testdatamap,Log);
