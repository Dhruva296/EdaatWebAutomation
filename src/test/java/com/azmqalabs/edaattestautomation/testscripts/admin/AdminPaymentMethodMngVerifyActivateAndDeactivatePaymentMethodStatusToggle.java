/**
*
* Test Script Name                   : AdminPaymentMethodMngVerifyActivateAndDeactivatePaymentMethodStatusToggle
* Test Data Sheet Name				 : AdminPayMngActAndDeactPayMethod
...
public class AdminPaymentMethodMngVerifyActivateAndDeactivatePaymentMethodStatusToggle {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminPayMngActAndDeactPayMethod";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminPaymentMethodMngVerifyActivateAndDeactivatePaymentMethodStatusToggle(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            Pages.AdminSystemMangement.VerifyActivateAndDeactivatePaymentMethodsStatusToggle(testdatamap,Log);       	
