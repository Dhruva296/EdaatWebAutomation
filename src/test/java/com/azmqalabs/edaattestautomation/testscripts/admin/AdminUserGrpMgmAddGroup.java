/**
*
* Test Script Name                   : AdminUserGrpMgmAddGroup
* Test Data Sheet Name				 : AdminAddNewGroup
* Objective                          : Verify to add new group under Users Management module
* Version                            : 1.0
...
public class AdminUserGrpMgmAddGroup {
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUserGrpMgmAddGroup(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngGrpsMngPage.addGroup(testdatamap,Log);
