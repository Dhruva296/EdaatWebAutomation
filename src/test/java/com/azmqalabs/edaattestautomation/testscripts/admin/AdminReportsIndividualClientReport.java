 /**
* Test Script Name                   : AdminReportsIndividualClientReport.
* TestData sheet Name                : AdminIndividualClientReport
* Objective                          : Verify to Generate Individual Client Report under Admin Reports.
* Version                            : 1.0
...
public class AdminReportsIndividualClientReport {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminIndividualClientReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReportsIndividualClientReport(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReportsAdminReportsPage.IndividualClientReport(testdatamap,Log);
