...
* Test Data Sheet Name				 : AdminUserGroupMgmClick
* Objective                          : Verify that the Group name is clickable under Users Management module
* Version                            : 1.0
...
public class AdminUserGrpMgmclick {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminUserGroupMgmClick";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUserGrpMgmclick(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngGrpsMngPage.VerifyGroupNameClick(testdatamap,Log);
