/**
*
* Test Script Name                   : AdminSystemMgmDistributionDailyTransferVerify.
* Test Data Sheet                    : AdminSysMgmDistDailyTransfer.
* Objective                          : Verify Daily Transfer Requests
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminSystemMgmDistributionDailyTransferVerify {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSysMgmDistDailyTransfer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMgmDistributionDailyTransferVerify(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMngDistributionPage.NavigateToDistributionDailyTransferRequest(Log);
	        	
	        	Pages.AdminSystemMngDistributionPage.VerifyDailyTransfer(testdatamap,Log);
