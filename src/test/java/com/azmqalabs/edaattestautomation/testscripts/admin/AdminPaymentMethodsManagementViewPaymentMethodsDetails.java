/**
* Test Script Name                      : AdminPaymentMethodsManagementViewPaymentMethodsDetails.
* Test Data SheetName					: AdminViewPaymentMethodsDetails
* Objective                             : [Admin] Verify to View Payment Methods details 
* Version                               : 1.0
* Author                                : Kalpana I R
...
public class AdminPaymentMethodsManagementViewPaymentMethodsDetails {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminViewPaymentMethodsDetails";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminPaymentMethodsManagementViewPaymentMethodsDetails(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMangement.VerifyViewPaymentMethodDetails(Log,testdatamap);
