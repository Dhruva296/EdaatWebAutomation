/**
*
* Test Script Name                   : AdminReportsReceivablesReportsSubBillersReport
* TestData Sheet                     : AdminReceivablesSubBillerReport
* Objective                          : Verify Sub Billers Report under ReceivableReports.
* Version                            : 1.0
* Author                             : Basavaraj Mudnur
* Created Date                       : 
* Last Updated on                    : N/A
* Updated By                         : 
* Pre-Conditions                     : 1)Biller Valid Login credentials
...
public class AdminReportsReceivablesReportsSubBillersReport{
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReceivablesSubBillerReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReportsReceivablesReportsSubBillersReport(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReportsReceivablesReportsPage.SubBillerReport(testdatamap,Log);
