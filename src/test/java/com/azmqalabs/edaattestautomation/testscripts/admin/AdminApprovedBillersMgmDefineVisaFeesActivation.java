/**
* Test Script Name                   : AdminApprovedBillersMgmDefineVisaFeesActivation
* Test Data Sheet Name				 : AdminDefineVisaFeesActivation
* Objective                          : Verify that  fees for avilable payment methode can be define in biller activation page  if the fees activation in payment method page is deactivated  
* Version                            : 1.0
...
public class AdminApprovedBillersMgmDefineVisaFeesActivation {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminDefineVisaFeesActivation";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminApprovedBillersMgmDefineVisaFeesActivation(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMangement.VerifyActivatePaymentMethodFreeActivationStatusToggle(testdatamap,Log);
	        	...
	        	Pages.AdminApprovedBillerManagement.ClickOnDefineVisaFeesActivationButton(testdatamap,Log);
