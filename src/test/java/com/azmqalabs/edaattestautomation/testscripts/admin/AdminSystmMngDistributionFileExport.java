/**
*
* Test Script Name                   : AdminSystmMngDistributionFileExport
* Test Data Sheet Name				 : AdminDailyFileExporting
* Objective                          : Verify Daily File Exporting under system management module
* Version                            : 1.0
...
public class AdminSystmMngDistributionFileExport {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminDailyFileExporting";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystmMngDistributionFileExport(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMngDistributionPage.NavigateDailyFileExport(Log);
	        	
	        	Pages.AdminSystemMngDistributionPage.VerifyDailyFileExporting(testdatamap,Log);
