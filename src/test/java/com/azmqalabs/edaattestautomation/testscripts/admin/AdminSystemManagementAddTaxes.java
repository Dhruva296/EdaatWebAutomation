/**
*
* Test case Script Name              :AdminSystemManagementAddTaxes
* Test Data Sheet Name				 :AdminAddTax
* Objective                          :Verify to Add Tax under System Management module
* Version                            :1.0
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMangement.navigateSystemMangementTax(Log);
	         	...
	         	Pages.AdminSystemMangement.AddTax(testdatamap,Log);
