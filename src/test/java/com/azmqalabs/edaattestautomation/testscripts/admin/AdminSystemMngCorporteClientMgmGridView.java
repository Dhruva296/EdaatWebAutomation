/**
* Test Script Name                   : AdminSystemMngCorporteClientMgmGridView
* Test Data Sheet Name				 : AdminSysMgmCorpoClientMgmView
* Objective                          : Verify Grid view details Under System Management Module
* Version                            : 1.0
...
public class AdminSystemMngCorporteClientMgmGridView {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSysMgmCorpoClientMgmView";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMngCorporteClientMgmGridView(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMngCorporateclientMngpage.CorporateclientMgmGridView(testdatamap,Log);
