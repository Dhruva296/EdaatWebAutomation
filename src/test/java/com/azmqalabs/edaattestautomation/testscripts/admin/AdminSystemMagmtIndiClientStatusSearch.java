/**
* Test Script Name                   : AdminSystemMagmtIndiClientStatusSearch
* Test Data Sheet Name				 : AdminIndivClientStatusSearch
* Objective                          : Verify to search based on the Client status under system management module
* Version                            : 1.0
...
public class AdminSystemMagmtIndiClientStatusSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminIndivClientStatusSearch";  
	...
	// FACTORY - DATA PROVIDER
	    ...
	    public AdminSystemMagmtIndiClientStatusSearch(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMgmIndividualClientPage.VerifyClientStatusSearch(testdatamap,Log);
