...
public class AdminSystemMngBillerCatAddSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminBillerCategoryAddSearch";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMngBillerCatAddSearch(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMgmBillersCategoriesMngpage.VerifyBillerCategoryAddSearch(testdatamap,Log);
