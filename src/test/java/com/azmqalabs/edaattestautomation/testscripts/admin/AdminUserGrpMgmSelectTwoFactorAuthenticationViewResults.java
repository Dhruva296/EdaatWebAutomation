/**
*
* Test Script Name                   : AdminUserGrpMgmSelectTwoFactorAuthenticationViewResults
* Test Data Sheet Name				 : AdminGrpMgmSelTwoFactViewResult
* Objective                          : Verify that if the 2-factor authentication checkbox is selected the user should fill the Time in Hours & the Type [Email or SMS]
* Version                            : 1.0
...
public class AdminUserGrpMgmSelectTwoFactorAuthenticationViewResults {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminGrpMgmSelTwoFactViewResult";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUserGrpMgmSelectTwoFactorAuthenticationViewResults(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngGrpsMngPage.selectTwoFactorAuthenticationViewResult(testdatamap,Log);
