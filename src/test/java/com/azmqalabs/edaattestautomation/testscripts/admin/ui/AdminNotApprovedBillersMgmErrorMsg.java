/**
* Test Script Name                   : AdminNotApprovedBillersMgmErrorMsg
* Objective                          : Verify to Approve Biller by Maker Error Message System Management module
* Version                            : 1.0
...
public class AdminNotApprovedBillersMgmErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdmNotApprBillersMgmSaveError";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminNotApprovedBillersMgmErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminNotApprovedBillerManagement.ApproveBillerErrorMsg(testdatamap,Log);
