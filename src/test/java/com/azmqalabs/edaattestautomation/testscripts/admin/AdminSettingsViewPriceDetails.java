/**
*
* Test Script Name                   : AdminSettingsViewPriceDetails 
...
* Pre-Conditions                     : 1)Admin Logged in with valid credentials.
                                       2)Price List should be present.
* Epic Details                       : N/A
...
public class AdminSettingsViewPriceDetails {

	// DECLARATION SECTION
	static String TestDataTab="AdminSettingsViewPrice";  
	...
	public AdminSettingsViewPriceDetails(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSettingsPricingListPage.ViewPriceDetails(testdatamap,Log);
