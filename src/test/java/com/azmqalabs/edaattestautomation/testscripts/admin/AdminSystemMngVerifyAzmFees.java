/**
*
* Test Script Name                   : AdminSystemMngVerifyAzmFees
* Test Data Sheet Name				 : AdminVerifyAzmFeesFixedValue
* Objective                          : Verify that AZM fees can be define as fixed value
* Version                            : 1.0
...
public class AdminSystemMngVerifyAzmFees {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminVerifyAzmFeesFixedValue";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMngVerifyAzmFees(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMangement.clickOnEditPaymentMethod(testdatamap);
	        	
	        	Pages.AdminSystemMangement.VerifyDefineAZMfeesForPaymentMethods(testdatamap,Log);	 
