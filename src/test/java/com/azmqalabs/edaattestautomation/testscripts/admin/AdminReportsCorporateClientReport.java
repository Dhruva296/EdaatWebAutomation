...
public class AdminReportsCorporateClientReport {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminCorporateClientReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReportsCorporateClientReport(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReportsAdminReportsPage.VerifyCorporateClientsReport(testdatamap,Log);
