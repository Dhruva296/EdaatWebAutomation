/**
*
* Test Script Name                   : AdminSystemMgmDistributionDailyTransferRecord 
* Test data sheet Name               : AdminSysMgmDistributionDailyRec
* Objective                          : Verify Daily Transfer Record under system managemnet module
* Version                            : 1.0
...
public class AdminSystemMgmDistributionDailyTransferRecord {

	// DECLARATION SECTION
	static String TestDataTab="AdminSysMgmDistributionDailyRec";  
	...
	public AdminSystemMgmDistributionDailyTransferRecord(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSystemMngDistributionPage.NavigateDailytransferRecord(Log);
			
			Pages.AdminSystemMngDistributionPage.verifyDaiytransferedRecord(testdatamap,Log);
