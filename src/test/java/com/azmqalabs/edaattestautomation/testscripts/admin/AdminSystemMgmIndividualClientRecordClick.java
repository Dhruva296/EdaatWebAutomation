/**
*
* Test Script Name                   : AdminSystemMgmIndividualClientRecordClick 
* Test data sheet Name               : AdminSysIndlClientRecordClick
...
public class AdminSystemMgmIndividualClientRecordClick {

	// DECLARATION SECTION
	static String TestDataTab="AdminSysIndlClientRecordClick";  
	...
	public AdminSystemMgmIndividualClientRecordClick(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSystemMgmIndividualClientPage.IndividualclientRequestRecord(testdatamap,Log);
