/**
*
* Test Script Name                   : AdminSettingsInvoicesTemplatesDelete.
* TestData Sheet Name                : AdminInvoiceTemplateDelete
* Objective                          : Verify delete Invoice button.
* Version                            : 1.0
* Author                             : Kathirvelu M
	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsPage.verfiyDeleteInvoiceTemplate(testdatamap,Log);
