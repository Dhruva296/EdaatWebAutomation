/**
* Test Script Name  				 : AdminUserMgmGroupsMgmSubjectToTwoFactorAuthenticationCheckbox
* Test Data Sheet Name				 : SubTwoFactorAuthentictnCheckbox
* Objective     					 : Verify the type checkbox have two values SMS,Email or both of them
* Version      						 : 1.0
* Author       						 : Kalpana I R
...
public class AdminUserMgmGroupsMgmSubjectToTwoFactorAuthenticationCheckbox {
	
	// DECLARATION SECTION
	  static String TestDataTab="SubTwoFactorAuthentictnCheckbox";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUserMgmGroupsMgmSubjectToTwoFactorAuthenticationCheckbox(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngGrpsMngPage.VerifySubjectToTwoFactorAuthenticationCheckbox(Log);
