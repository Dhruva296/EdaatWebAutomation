/**
*
* Test Script Name                   : AdminSystemMagmtCorporateClientReqRec
* Objective                          : Verify Request Record button under system management module
* Version                            : 1.0
* Author                             : Kathirvelu Mohan
* Created Date                       : 23/05/2023
* Last Updated on                    : N/A
* Updated By                         : Obala Nayak m s
...
public class AdminSystemMagmtCorporateClientReqRec{
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminCorporateReqRecord";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMagmtCorporateClientReqRec(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMngCorporateclientMngpage.VerifyRequestRecordButton(testdatamap,Log);
