...
public class AdminSettingsDiscountMgmAddDeacitvate {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSettingDiscountAddDeactive";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsDiscountMgmAddDeacitvate(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsDiscountPage.verifyAddDeactivateDiscount(testdatamap,Log);
