/**
* Test Script Name  				 : AdminSettingsViewTermsManagements.
* TestDataSheetName					 : AdminViewTermsManagement
* Objective     					 : To Verify  view term details button under Terms Management
* Version      						 : 1.0
...
public class AdminSettingsViewTermsManagements{
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminViewTermsManagement";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsViewTermsManagements(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingTermsManagementPage.VerifyToviewActiveTerm(testdatamap,Log);
