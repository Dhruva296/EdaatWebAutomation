/**
* Test Script Name                   : AdminSystemMngBillerCategoriesSearch
* Test Data Sheet Name				 : AdminBillerCategorySearch
* Objective                          : 1)Verify the search functionality under System Management module
									   2)Verify to Add Biller Category under System Management module
* Version                            : 1.0
...
public class AdminSystemMngBillerCategoriesSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminBillerCategorySearch";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMngBillerCategoriesSearch(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMgmBillersCategoriesMngpage.NavigateBillerCategoriesManagement(Log);;
	        	
	        	Pages.AdminSystemMgmBillersCategoriesMngpage.VerifytheBillerCategorySearch(testdatamap,Log);
