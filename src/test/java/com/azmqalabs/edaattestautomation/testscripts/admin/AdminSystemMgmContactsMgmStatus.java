/**
* Test Script Name                   : AdminSystemMgmContactsMgmStatus
* Test data sheet Name               : AdminContactsMgmStatus
* Objective                          : Verify the status [Seen,Replied,Not Seen] Under System Management module
* Version                            : 1.0
...
public class AdminSystemMgmContactsMgmStatus {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminContactsMgmStatus";
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMgmContactsMgmStatus(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMangementContactsPage.contactsStatus(testdatamap,Log);
