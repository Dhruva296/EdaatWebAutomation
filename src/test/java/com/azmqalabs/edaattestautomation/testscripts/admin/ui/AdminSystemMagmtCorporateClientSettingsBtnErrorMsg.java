...
public class AdminSystemMagmtCorporateClientSettingsBtnErrorMsg{
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMagmtCorporateClientSettingsBtnErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMngCorporateclientMngpage.CorporateClientSettingsBtnErrorMsg(testdatamap,Log);
