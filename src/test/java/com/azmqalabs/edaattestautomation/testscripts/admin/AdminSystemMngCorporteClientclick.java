/**
* Test Script Name                   : AdminSystemMngCorporteClientclick
* Test Data Sheet Name				 : AdminCorporateclick
* Objective                          : Verify that the Corporate name is clickable under System Management module
* Version                            : 1.0
...
public class AdminSystemMngCorporteClientclick {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminCorporateclick";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMngCorporteClientclick(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMngCorporateclientMngpage.VerifyCorporateNameClick(testdatamap,Log);
