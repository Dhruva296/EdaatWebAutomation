/**
*
* Test Script Name                   : AdminSystemMgmDistributionDailyTransferVerifyErrorMsg
...
public class AdminSystemMgmDistributionDailyTransferVerifyErrorMsg {
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMgmDistributionDailyTransferVerifyErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMngDistributionPage.VerifyDailyTransferErrorMsg(testdatamap,Log);
