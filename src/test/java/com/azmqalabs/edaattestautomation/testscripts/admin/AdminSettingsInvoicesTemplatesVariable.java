/**
* Test Script Name                   : AdminSettingsInvoicesTemplatesVariable
* TestData Sheet Name                : AdminInvoiceTemplateView
* Objective                          : Verify Invoice template variables 
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminSettingsInvoicesTemplatesVariable {
	...
	// DECLARATION SECTION
	  static String TestDataTab="AdminInvoiceTemplteViewVariable";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsPage.verifyInvoiceTemplateVariables(testdatamap,Log);
