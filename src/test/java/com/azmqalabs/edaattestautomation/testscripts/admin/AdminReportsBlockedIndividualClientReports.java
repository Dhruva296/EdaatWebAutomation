 /**
* Test Script Name                   : AdminReportsBlockedIndividualClientReports
* TestData sheet Name                : AdminBlockedIndivClientReport
* Objective                          : Verify Blocked Individual Clients Report under Reports Module
* Version                            : 1.0
...
public class AdminReportsBlockedIndividualClientReports {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminBlockedIndivClientReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReportsBlockedIndividualClientReports(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReportsAdminReportsPage.VerifyBlockedIndividualClientReport(testdatamap,Log);
