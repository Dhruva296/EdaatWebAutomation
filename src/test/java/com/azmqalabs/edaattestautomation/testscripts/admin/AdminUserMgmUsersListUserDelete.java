/**
* Test Script Name                   : AdminUserMgmUsersListUserDelete
* Test Data Sheet Name				 : AdminUsersListUserDelete
* Objective                          : Verify Delete user functionality Under User Management module
* Version                            : 1.0
...
public class AdminUserMgmUsersListUserDelete {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminUsersListUserDelete";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUserMgmUsersListUserDelete(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngUserListPage.verifyUsersDelete(testdatamap,Log);
