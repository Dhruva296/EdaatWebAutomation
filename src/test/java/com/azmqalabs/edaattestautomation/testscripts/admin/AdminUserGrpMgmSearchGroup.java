/**
* Test Script Name                   : AdminUserGrpMgmSearchGroup
* Test Data Sheet Name				 : AdminSearchGroup
* Objective                          : 1)Verify the search group functionality under User management module
* Version                            : 1.0
...
public class AdminUserGrpMgmSearchGroup {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSearchGroup";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUserGrpMgmSearchGroup(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngGrpsMngPage.searchGroup(testdatamap,Log);
