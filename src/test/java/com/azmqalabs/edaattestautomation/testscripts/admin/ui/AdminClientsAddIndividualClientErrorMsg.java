...
public class AdminClientsAddIndividualClientErrorMsg {
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminIndividualClientPage.VerifyAddIndClietErrorMsg(FullName,SecondName,ThirdName,LastName,NationalID,Year,Month,Date,MobileNo,Email,Refno,ExpectedResult,Log);
