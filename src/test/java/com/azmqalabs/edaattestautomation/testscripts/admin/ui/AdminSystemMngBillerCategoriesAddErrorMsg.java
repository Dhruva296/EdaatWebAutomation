...
* Test Data Sheet Name				 : AdminBillerCategoryAdd
* Objective                          : Verify Add Biller Category Error Messages under System Management module
* Version                            : 1.0
...
public class AdminSystemMngBillerCategoriesAddErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminBillerCategoryAdd";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMngBillerCategoriesAddErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMgmBillersCategoriesMngpage.VerifyBillerCategoryAddErrorMsg(testdatamap,Log);
