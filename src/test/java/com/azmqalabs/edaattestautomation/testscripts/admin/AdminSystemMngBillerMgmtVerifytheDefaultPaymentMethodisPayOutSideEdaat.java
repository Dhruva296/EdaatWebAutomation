 /**
* Test Script Name                   : AdminSystemMngBillerCatAddSearch.
* TestData sheet Name                : AdminBillerCategoryAddSearch.
* Objective                          : Verify to Add Category and Search in Biller Category under System Management.
* Version                            : 1.0
...
public class AdminSystemMngBillerMgmtVerifytheDefaultPaymentMethodisPayOutSideEdaat {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminDefaultPaymentIsPayOutEdat";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMngBillerMgmtVerifytheDefaultPaymentMethodisPayOutSideEdaat(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminNotApprovedBillerManagement.searchNotApprovedBillerMgm(testdatamap.get("CompanyName").toString(),Log);

	        	Pages.AdminSystemMangement.VerifythattheDefaultPaymentMethodisPayOutsideEdaat(testdatamap, Log);
