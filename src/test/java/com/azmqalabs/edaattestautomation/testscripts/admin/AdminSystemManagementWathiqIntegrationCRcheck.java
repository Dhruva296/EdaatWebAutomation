/**
* Test Script Name                   : AdminSystemManagementWathiqIntegrationCRcheck
...
public class AdminSystemManagementWathiqIntegrationCRcheck {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSystemMgmWathiqCRCheck";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemManagementWathiqIntegrationCRcheck(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemManagementWathiqIntegrationPage.NavigateWathiqIntegrationCRCheck(Log);
	        	
	        	Pages.AdminSystemManagementWathiqIntegrationPage.WathiqIntegrationCRCheck(testdatamap,Log);
