/**
*
* Test Script Name                   : AdminReportsOutsideEdaatPaymentsReport.
* TestData Sheet Name                : AdminReportsOutsideEdaatPayment
* Objective                          : Verify Outside EDAAT Payments Report
* Version                            : 1.0
* Author                             : Kathirvelu M
...
* Pre-Conditions                     : 1)Admin valid Login Credentials. 
                                       2)Outside paid edaat bills should be present.
* Epic Details                       : N/A
...
public class AdminReportsOutsideEdaatPaymentsReport {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReportsOutsideEdaatPayment";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReportsOutsideEdaatPaymentsReport(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReportsAdminReportsPage.VerifyOutsideEdaatPaymentReports(testdatamap,Log);
