/**
*
* Test Script Name                   : AdminSystemMgmPaymentMethodMgmVerifyTheMessageWhenTheUserChangeTheCategoryFromInvoiceBasedToTransactionCountAndViseVersa 
* Test data sheet Name               : AdminPaymentMgmInvoiceToTransac
* Objective                          : Verify the message when the user change the category from Invoice based to Transaction count and via versa
* Version                            : 1.0
...
public class AdminSystemMgmPaymentMethodMgmVerifyTheMessageWhenTheUserChangeTheCategoryFromInvoiceBasedToTransactionCountAndViseVersa {

	// DECLARATION SECTION
	static String TestDataTab="AdminPaymentMgmInvoiceToTransac";  
	...
	public AdminSystemMgmPaymentMethodMgmVerifyTheMessageWhenTheUserChangeTheCategoryFromInvoiceBasedToTransactionCountAndViseVersa(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSystemMangement.verifyToChangeTheCategoryFromInvoiceBasedToTransactionCountAndViceVersa(testdatamap,Log);
