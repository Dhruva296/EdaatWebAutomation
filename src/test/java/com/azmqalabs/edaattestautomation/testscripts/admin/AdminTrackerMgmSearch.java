/**
* Test Script Name                   : AdminTrackerMgmSearch
* Test Data Sheet Name				 : AdmTrackerBillerMgmSearch
* Objective                          : 1)Verify the search functionality under System Management module
*									 : 2)Verify that Total Individual Clients is clickable under System Management module
* Version                            : 1.0
	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminNotApprovedBillerManagement.CreateTrackerBill(testdatamap,Log);
	        	
	        	Pages.AdminSystemMangement.navigateTrackerBillerManagement(Log);
	        	
	        	Pages.AdminTrackerBillerManagementPage.verifySearchTrackerBiller(testdatamap,Log);
	        	
	        	Pages.AdminTrackerBillerManagementPage.verifyIndividualClientIDClickable(Log); 
