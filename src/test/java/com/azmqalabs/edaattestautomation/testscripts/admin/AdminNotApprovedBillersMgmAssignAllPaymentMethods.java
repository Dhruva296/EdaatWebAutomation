  /**
* Test Script Name                   : AdminNotApprovedBillersMgmAssignAllPaymentMethods
* Test Data Sheet Name				 : AdmNotApprBilMgmPaymentMethod
* Objective                          : Verify that the Admin is able to assign all the payment methods under System Management module
* Version                            : 1.0
...
public class AdminNotApprovedBillersMgmAssignAllPaymentMethods {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdmNotApprBilMgmPaymentMethod";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminNotApprovedBillersMgmAssignAllPaymentMethods(Map<Object, Object> testdatamap){
