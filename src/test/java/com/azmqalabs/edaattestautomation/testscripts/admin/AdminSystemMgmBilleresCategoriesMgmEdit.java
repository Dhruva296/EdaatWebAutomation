/**
*
* Test case Script Name              :AdminSystemMgmBilleresCategoriesMgmEdit
* Test Data Sheet Name				 :AdminBilleresCategoriesMgmEdit
* Objective                          :Verify Edit Category button Under Biller Categories Management
* Version                            :1.0
...
public class AdminSystemMgmBilleresCategoriesMgmEdit {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminBilleresCategoriesMgmEdit";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMgmBilleresCategoriesMgmEdit(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMgmBillersCategoriesMngpage.NavigateBillerCategoriesManagement(Log);
	         	...
	         	Pages.AdminSystemMgmBillersCategoriesMngpage.verifyEditBillerCategory(testdatamap,Log);
