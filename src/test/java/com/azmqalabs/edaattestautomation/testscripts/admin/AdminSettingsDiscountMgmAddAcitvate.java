/**
* Test Script Name                   : AdminSettingsDiscountMgmAddDeacitvate
* TestData Sheet Name                : AdminSettingDiscountAddDeactive
* Objective                          : Verify to enter valid Invoice Number 
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminSettingsDiscountMgmAddAcitvate {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSettingDiscountAddActivate";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsDiscountMgmAddAcitvate(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsDiscountPage.VerifyAddDiscountActivate(testdatamap,Log);
