/**
*
* Test Script Name                   : AdminSystemMgmCorporateClientMgmSearch
* Test data sheet Name               : AdminSysMgmCorporatClientSearch
* Objective                          : Verify to search based on the Client status [Registered,Added,Approved]  under System Management module
* Version                            : 1.0
...
public class AdminSystemMgmCorporateClientMgmSearch {

	// DECLARATION SECTION
	static String TestDataTab="AdminSysMgmCorporatClientSearch";  
	...
	public AdminSystemMgmCorporateClientMgmSearch(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSystemMngCorporateclientMngpage.CorporateClientManagementSearchBasedOnClientStatus(testdatamap,Log);
