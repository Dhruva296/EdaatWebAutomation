/**
* Test Script Name                   : AdminUserListAddNewUser
* TestData Sheet Name                : AdminUserListAddUser
* Objective                          : Verify to add new user account under User Management Module
* Version                            : 1.0
...
public class AdminUserListAddNewUser {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminUserListAddUser";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUserListAddNewUser(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngUserListPage.AddUserAndVerify(testdatamap,Log);
