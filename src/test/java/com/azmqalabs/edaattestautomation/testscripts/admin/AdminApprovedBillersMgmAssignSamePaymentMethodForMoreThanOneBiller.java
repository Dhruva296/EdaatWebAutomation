  /**
* Test Script Name                   : AdminApprovedBillersMgmAssignSamePaymentMethodForMoreThanOneBiller
* Test Data Sheet Name				 : AdmApprBilMgmSamePaymentMethod
* Objective                          : Verify to add the same payment method for more than one biller under System Management module
* Version                            : 1.0
...
public class AdminApprovedBillersMgmAssignSamePaymentMethodForMoreThanOneBiller {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdmApprBilMgmSamePaymentMethod";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminApprovedBillersMgmAssignSamePaymentMethodForMoreThanOneBiller(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminNotApprovedBillerManagement.verifyToAssignSamePaymentMethodForMoreThanOneBiller(testdatamap,Log);
