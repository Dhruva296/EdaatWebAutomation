/**
* Test Script Name  				 : AdminSettingsPricingListDelete
* Objective     					 : To Verify delete pricelist button under settings module
* Version      						 : 1.0
...
public class AdminSettingsPricingListDelete {
	
	// DECLARATION SECTION
		  static String TestDataTab="AdminPriceListDelete";  
		  ...
		  DBUtil DBUtil;
		    ...
		    public  AdminSettingsPricingListDelete(Map<Object, Object> testdatamap){
...
//		    @Parameters({ "username", "password" })
		    ...
		    public void myTest() throws InterruptedException, Exception{
		        try{
		        	...
		        	Pages.AdminSettingsPricingListPage.VerifyPriceListDelete(testdatamap,Log);
