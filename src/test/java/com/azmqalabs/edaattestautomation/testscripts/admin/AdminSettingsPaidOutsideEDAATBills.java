/**
* Test Script Name                      : AdminSettingsPaidOutsideEDAATBills.
* TestDataSheet                         : AdminSettingsPaidOutsideEDAATBills
...
public class AdminSettingsPaidOutsideEDAATBills {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSettingsPaidOutsideEdaat";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsPaidOutsideEDAATBills(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsPage.VerifyUploadBulkDataForPaidOutEdaatBills(Log);
