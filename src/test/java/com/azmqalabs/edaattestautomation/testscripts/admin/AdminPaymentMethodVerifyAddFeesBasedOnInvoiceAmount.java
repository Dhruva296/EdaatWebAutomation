/**
*
* Test Script Name                   : AdminPaymentMethodVerifyAddFeesBasedOnInvoiceAmount
* Test Data Sheet Name				 : AdminVerifyAddFeesBsdOnInvoice
* Objective                          : Verify to add Fees based on invoice value in the payment method  
* Version                            : 1.0
...
public class AdminPaymentMethodVerifyAddFeesBasedOnInvoiceAmount {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminVerifyAddFeesBsdOnInvoice";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminPaymentMethodVerifyAddFeesBasedOnInvoiceAmount(Map<Object, Object> testdatamap){
