...
public class AdminReceivablesVerifyTransferRemarkFieldNotAppears {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReceTRfieldNotdisplay";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReceivablesVerifyTransferRemarkFieldNotAppears(Map<Object, Object> testdatamap){
