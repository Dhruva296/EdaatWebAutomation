/**
* Test Script Name                   : AdminSettingsDiscountMgmSearch.
* TestData Sheet Name                : AdminSettingDiscountSearch.
* Objective                          : Verify to Search discount under Discount Management.
* Version                            : 1.0
...
public class AdminSettingsDiscountMgmSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSettingDiscountSearch";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsDiscountMgmSearch(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsDiscountPage.SearchDiscount(testdatamap,Log);
