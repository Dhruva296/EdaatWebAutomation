 /**
* Test Script Name                   : AdminSystemMngBillerMgmtVerifyNewCheckboxViewedAfterAdminCheckSubbillerCheckbox.
* TestData sheet Name                : AdminCheckSubBillerCheckBox.
* Objective                          : Verify that a new check box viewed after admin check the sub biller check box under System Management module.
* Version                            : 1.0
...
public class AdminSystemMngBillerMgmtVerifyNewCheckboxViewedAfterAdminCheckSubbillerCheckbox {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminNotApprCheckSubBillerCheck";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMngBillerMgmtVerifyNewCheckboxViewedAfterAdminCheckSubbillerCheckbox(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminNotApprovedBillerManagement.verifyTheNewCheckboxViewedAfterCheckTheSubBillerCheckBox(testdatamap,Log);
