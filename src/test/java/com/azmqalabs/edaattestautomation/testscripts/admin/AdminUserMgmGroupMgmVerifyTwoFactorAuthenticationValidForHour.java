/**
* Test Script Name                   : AdminUserMgmGroupMgmVerifyTwoFactorAuthenticationValidForHour 
* Test data sheet Name               : AdminGrpMgmTwoFactorValidHour
* Objective                          : Verify delete group functionality under usermanagement module
* Version                            : 1.0
* Author                             : Kathirvelu Mohan
* Created Date                       : 29/04/2024
* Last Updated on                    : N/A
* Updated By                         : Radhika K R
* Pre-Conditions                     : 1)Admin should be logged in
                                       2)Group details should be present                               
* Epic Details                       : N/A
...
public class AdminUserMgmGroupMgmVerifyTwoFactorAuthenticationValidForHour {

	// DECLARATION SECTION
	static String TestDataTab="AdminGrpMgmTwoFactorValidHour";  
	...
	public AdminUserMgmGroupMgmVerifyTwoFactorAuthenticationValidForHour(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminUserMngGrpsMngPage.verifyTwoFactorAuthenticationValidForHourTextfield(testdatamap,Log);
