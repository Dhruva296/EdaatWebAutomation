/**
*
* Test Script Name                   : AdminSystemMgmPaymentMethodMgmGridViewDetails 
* Test data sheet Name               : AdminPaymentMethodMngGridView
* Objective                          : Verify the Grid view details for Payment Methods Management page under System Management module
* Version                            : 1.0
...
public class AdminSystemMgmPaymentMethodMgmGridViewDetails {

	// DECLARATION SECTION
	static String TestDataTab="AdminPaymentMethodMngGridView";  
	...
	public AdminSystemMgmPaymentMethodMgmGridViewDetails(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSystemMangement.verifyPaymentMethodManagementGridViewDetails(testdatamap,Log);
