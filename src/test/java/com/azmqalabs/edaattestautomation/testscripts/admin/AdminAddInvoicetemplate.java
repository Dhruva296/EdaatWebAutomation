	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminAddInvoicetemplate(Map<Object, Object> testdatamap){
	        ...
	        this.ReferenceCode=testdatamap.get("ReferenceCode").toString();
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsPage.AddInvoicetemplate(TemplateArabic,TemplateEnglish,InvoiceType,ReferenceCode,Log);

	        	Pages.AdminSettingsPage.AdminSearchtemplate(TemplateEnglish,Log);
