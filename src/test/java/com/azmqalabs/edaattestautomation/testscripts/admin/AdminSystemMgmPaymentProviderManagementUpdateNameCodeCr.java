/**
*
* Test Script Name                   : AdminSystemMgmSubBillerEditbutton 
* Test data sheet Name               : AdminSystemMgmSubBillerEditbtn
* Objective                          : Verify Edit button for the sub biller accounts Under System  Mangagement Module
* Version                            : 1.0
...
public class AdminSystemMgmPaymentProviderManagementUpdateNameCodeCr {

	// DECLARATION SECTION
	static String TestDataTab="AdminPaymentProviderUpdate";  
	...
	public AdminSystemMgmPaymentProviderManagementUpdateNameCodeCr(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSystemMangement.toUpdateTheNameCodeCR(testdatamap, Log);
