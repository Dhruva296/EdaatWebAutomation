/**
* Test Script Name                   : AdminSettingsTermsManagementSearch
* TestData Sheet Name                : AdminSettingsTermsMgmSearch
* Objective                          : Verify search functionality under Terms Management module.
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminSettingsTermsManagementSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSettingsTermsMgmSearch";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsTermsManagementSearch(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingTermsManagementPage.SettingsTermsManagementSearchTerm(testdatamap,Log);
