/**
* Test Script Name                   : AdminUserMgmGroupMgmVerifyDeleteGroup 
* Test data sheet Name               : AdminUserMgmGroupMgmDeleteGroup
...
public class AdminUserMgmGroupMgmVerifyDeleteGroup {

	// DECLARATION SECTION
	static String TestDataTab="AdminUserMgmGroupMgmDeleteGroup";  
	...
	public AdminUserMgmGroupMgmVerifyDeleteGroup(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminUserMngGrpsMngPage.VerifyDeleteGroupFunctionality(testdatamap,Log);
