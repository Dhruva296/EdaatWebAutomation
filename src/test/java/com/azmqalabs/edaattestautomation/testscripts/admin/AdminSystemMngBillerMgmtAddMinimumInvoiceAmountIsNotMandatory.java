 /**
* Test Script Name                   : AdminSystemMngBillerMgmtAddMinimumInvoiceAmountIsNotMandatory.
* TestData sheet Name                : AdminNewCheckBoxisOptional.
* Objective                          : Verify that a new check box "add minimum invoice amount" is not mandatory under System Management.
* Version                            : 1.0
...
public class AdminSystemMngBillerMgmtAddMinimumInvoiceAmountIsNotMandatory {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminNotApprNewCheckBoxisOpt";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMngBillerMgmtAddMinimumInvoiceAmountIsNotMandatory(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminNotApprovedBillerManagement.verifyTheNewCheckboxAddMinimumInvoiceAmountIsNotMandatory(testdatamap,Log);
