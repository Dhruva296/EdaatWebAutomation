/**
* Test Script Name                      : AdminPaymentMethodsManagement.
* Test Data SheetName					: AdminPaymentMethodsManagement
* Objective                             : [Admin] Verify new "Payment method management" page is added 
* Version                               : 1.0
* Author                                : Kalpana I R
...
public class AdminPaymentMethodsManagement {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminPaymentMethodsManagement";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminPaymentMethodsManagement(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMangement.VerifyPaymentMethodsManagementPageIsAdded(Log);
