/**
*
* Test Script Name                   : AdminUserMgmUserListDeletedUsersCheckBox 
* Test data sheet Name               : AdminUserMgmUserLstDltUserCheck
* Objective                          : Verify Deleted Users checkbox under usermanagement module
* Version                            : 1.0
...
* Pre-Conditions                     : 1)Valid Admin login credentials 
                                       2)Deleted user should be present                                 
* Epic Details                       : N/A
...
public class AdminUserMgmUserListDeletedUsersCheckBox {

	// DECLARATION SECTION
	static String TestDataTab="AdminUserMgmUserLstDltUserCheck";  
	...
	public AdminUserMgmUserListDeletedUsersCheckBox(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminUserMngUserListPage.SearchUserCheckbox(testdatamap,Log);
