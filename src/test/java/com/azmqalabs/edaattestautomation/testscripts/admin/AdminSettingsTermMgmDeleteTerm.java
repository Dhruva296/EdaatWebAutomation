/**
*
* Test Script Name                   : AdminSettingsTermMgmDeleteTerm 
* TestData Sheet Name                : AdminTermsMgmDeleteTerm
* Objective                          : Verify delete term button
* Version                            : 1.0
...
public class AdminSettingsTermMgmDeleteTerm {

	// DECLARATION SECTION
	static String TestDataTab="AdminTermsMgmDeleteTerm";  
	...
	public AdminSettingsTermMgmDeleteTerm(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSettingTermsManagementPage.VerifyDeleteTerms(testdatamap,Log);
