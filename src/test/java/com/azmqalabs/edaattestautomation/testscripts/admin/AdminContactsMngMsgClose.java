/**
* Test Script Name                   : AdminContactsMngMsgClose
* Test Data Sheet Name				 : AdminContactsMsgClose
* Objective                          : Verify Message Details & Close functionality under System Management module
* Version                            : 1.0
...
public class AdminContactsMngMsgClose{
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminContactsMsgClose";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminContactsMngMsgClose(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMangementContactsPage.verifyMessageDetailsandClose(testdatamap,Log);
