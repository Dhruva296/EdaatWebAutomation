 /**
* Test Script Name                   : AdminReportsBillersTrasanctions
* TestData sheet Name                : AdminReportsBillerTransactions
* Objective                          : Verify Billers Transactions Report
* Version                            : 1.0
* Author                             : Kathirvelu M
...
* Pre-Conditions                     : 1)Admin Logged in with valid Credentials. 
                                       2)Super biller should be present. 
* Epic Details                       : N/A
...
public class AdminReportsBillersTrasanctions {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReportsBillerTransactions";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReportsBillersTrasanctions(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReportsAdminReportsPage.VerifyBillerTransactionReport(testdatamap,Log);
