 /**
* Test Script Name                   : AdminReportsSuperBillerReport
* TestData sheet Name                : AdminSuperBillerReport
* Objective                          : To Verfiy Super biller report.
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminReportsSuperBillerReport {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSuperBillerReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReportsSuperBillerReport(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReportsAdminReportsPage.VerifySuperBillerReport(testdatamap,Log);
