 /**
* Test Script Name                   : AdminReportsCorporateBillersReport
* TestData sheet Name                : AdminCorporateBillerReport
* Objective                          : Verify Corporate Billers Report Under Reports module
* Version                            : 1.0
...
public class AdminReportsCorporateBillersReport {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminCorporateBillerReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReportsCorporateBillersReport(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReportsAdminReportsPage.VerifyCorporateBilllersReport(Log);
