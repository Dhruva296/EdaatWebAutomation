 /**
* Test Script Name                   : AdminReportsClientsTypeReport
* TestData sheet Name                : AdminClientsTypeReport
* Objective                          : Verify ClientsType Report under Admin Reports
* Version                            : 1.0
* Author                             : Kathirvelu M
* Created Date                       : 
* Last Updated on                    : N/A
...
public class AdminReportsClientsTypeReport {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminClientsTypeReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReportsClientsTypeReport(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReportsAdminReportsPage.VerifyClientsTypersReport(testdatamap,Log);
