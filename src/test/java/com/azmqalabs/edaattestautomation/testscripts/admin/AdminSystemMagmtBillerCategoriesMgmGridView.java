/**
* Test Script Name                   : AdminSystemMagmtBillerCategoriesMgmGridView
* Test Data Sheet Name				 : AdminSysMgmBillerCateGridView
...
public class AdminSystemMagmtBillerCategoriesMgmGridView {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSysMgmBillerCateGridView";  
	...
	// FACTORY - DATA PROVIDER
	    ...
	    public AdminSystemMagmtBillerCategoriesMgmGridView(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMgmBillersCategoriesMngpage.VerifyBillerCategoryGridView(testdatamap,Log);
