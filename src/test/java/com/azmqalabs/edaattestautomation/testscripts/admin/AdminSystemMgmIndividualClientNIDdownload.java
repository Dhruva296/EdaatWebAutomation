/**
*
* Test Script Name                   : AdminSystemMgmIndividualClientNIDdownload
* Test Data Sheet                    : AdminIndivNIDdownload
* Objective                          : Verify to Download the NationalID under system management module
* Version                            : 1.0
...
public class AdminSystemMgmIndividualClientNIDdownload {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminIndivNIDdownload";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMgmIndividualClientNIDdownload(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMgmIndividualClientPage.NationalIdDownload(testdatamap,Log);
