/**
*
* Test Script Name                   : AdminUserGrpMgmAddGroupErrorMsg
* Test Data Sheet Name				 : AdminAddNewGroup
* Objective                          : Verify add group Error Message under Users Management module
* Version                            : 1.0
...
public class AdminUserGrpMgmAddGroupErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminAddNewGroup";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUserGrpMgmAddGroupErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngGrpsMngPage.AddGroupErrorMsg(testdatamap,Log);
