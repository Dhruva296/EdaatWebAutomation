/**
* Test Script Name  				 : AdminSysMgmBillerMgmAssignNewPaymentMethodByAdmin
* Test Data Sheet Name				 : AdminSysBlrMgmAssignNewPayment
...
public class AdminSysMgmBillerMgmAssignNewPaymentMethodByAdmin {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSysBlrMgmAssignNewPayment";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSysMgmBillerMgmAssignNewPaymentMethodByAdmin(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminNotApprovedBillerManagement.VerifyAdminAbleToAssignNewPaymentType(testdatamap,Log);
