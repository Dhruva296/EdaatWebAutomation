/**
*
* Test Script Name                      : AdminApprovedBillersMgmCustomizedTransferNotesIsCheckable.
* Test Data Sheet                       : CustomTransferNoteIsCheckable.
* Objective                             :1) Verify that  a new  checkbox “Customized Transfer Notes” is updatable any time
* 										 2) Verify that  new check box isn't mandatory 
* Version                               : 1.0
* Author                                : Kalpana I R
...
public class AdminApprovedBillersMgmCustomizedTransferNotesIsCheckable {
	
	// DECLARATION SECTION
	  static String TestDataTab="CustomTransferNoteIsCheckable";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminApprovedBillersMgmCustomizedTransferNotesIsCheckable(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminApprovedBillerManagement.searchforapprbiller(testdatamap,Log);
	        	
	        	Pages.AdminApprovedBillerManagement.VerifyCustomizedTransferNotesIsupdatableAnyTime(testdatamap,Log);
