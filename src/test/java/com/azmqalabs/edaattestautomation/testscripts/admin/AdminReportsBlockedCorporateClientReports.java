/**
*
* Test Script Name                   : AdminReportsBlockedCorporateClientReports 
* Test data sheet Name               : AdminReportsBlockedCorpClient
* Objective                          : Verify  Blocked Corporate Clients Report
* Version                            : 1.0
...
public class AdminReportsBlockedCorporateClientReports {

	// DECLARATION SECTION
	static String TestDataTab="AdminReportsBlockedCorpClient";  
	...
	public AdminReportsBlockedCorporateClientReports(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminReportsAdminReportsPage.VerifyBlockedCorporateClientReport(Log);
