...
public class AdminSystemMgmSubBillerEditbutton {

	// DECLARATION SECTION
	static String TestDataTab="AdminSystemMgmSubBillerEditbtn";  
	...
	public AdminSystemMgmSubBillerEditbutton(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSystemMgmSubBillersPage.NavigateSubBillersManagement(Log);

			Pages.AdminSystemMgmSubBillersPage.EditSubBillerAccount(Log);
