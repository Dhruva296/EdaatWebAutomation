/**
* Test Script Name                   : AdminSystemMgmDistributionEODSettlementReportErrorMsg
* Test Data Sheet                    : AdminSysMgmDistEODSettlement
...
public class AdminSystemMgmDistributionEODSettlementReportErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSysMgmDistEODSettlement";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMgmDistributionEODSettlementReportErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMngDistributionPage.NavigateToDistributionEODSettlementReport(Log);
	        	
	        	Pages.AdminSystemMngDistributionPage.VerifyEODSettlementReportErrorMsg(testdatamap,Log);
