/**
*
* Test Script Name                   : AdminSystemMgmPaymentMethodMgmVerifyCategoryFees 
* Test data sheet Name               : AdminPaymentMethodMngFees
* Objective                          : Verify that the  priority is for category fees when  deduction payment methode fees under System Management module
* Version                            : 1.0
...
public class AdminSystemMgmPaymentMethodMgmVerifyCategoryFees {

	// DECLARATION SECTION
	static String TestDataTab="AdminPaymentMethodMngFees";  
	...
	public AdminSystemMgmPaymentMethodMgmVerifyCategoryFees(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSystemMangement.verifyThePriorityIsForCategoryFees(testdatamap,Log);
