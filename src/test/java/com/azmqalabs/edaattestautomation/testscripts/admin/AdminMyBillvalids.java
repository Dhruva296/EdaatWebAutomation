/**
* Test Script Name                   : AdminMyBillvalids
* Test Data Sheet Name				 : MyBillsvalid
* Objective                          : Verify to enter valid Invoice Number under My Bills module
* Version                            : 1.0
...
* Pre-Conditions                     : 1)Valid Admin Login Credentials
									 : 2)Valid Bill Number should be present
* Epic Details                       : N/A
...
public class AdminMyBillvalids {
	
	// DECLARATION SECTION
	  static String TestDataTab="MyBillsvalid";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminMyBillvalids(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.MyBillsPage.verifyValidBillNumberMessage(testdatamap,Log);
