/**
* Test Script Name                   : AdminNotApprovedMgmCloseBiller
* Test Data Sheet Name				 : AdmNotApprBilMgmClose
* Objective                          : 1)Verify to click on close button without doing any action by maker under System Management module			
  								     : 2) Verify to check the activation info from checker side to approve account activation under System Management module
* Version                            : 1.0
...
public class AdminNotApprovedMgmCloseBiller{
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminNotApprovedBillerManagement.VerifyClosedBillerForDeactivate(testdatamap,Log);
