/**
* Test Script Name                   : AdminSystemMagmtIndiClientGridView
* Test Data Sheet Name				 : AdminIndiClientGridView
...
public class AdminSystemMagmtIndiClientGridView {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminIndiClientGridView";  
	...
	// FACTORY - DATA PROVIDER
	    ...
	    public AdminSystemMagmtIndiClientGridView(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMgmIndividualClientPage.IndivudualClientGridView(testdatamap,Log);
