/**
*
* Test Script Name                   : AdminPaymentMethodMngVerifyActivateAndDeactivatePaymentMethodFeesActivationToggle
* Test Data Sheet Name				 : AdminPayMngActAndDeactFeesAct
...
public class AdminPaymentMethodMngVerifyActivateAndDeactivatePaymentMethodFeesActivationToggle {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminPayMngActAndDeactFeesAct";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminPaymentMethodMngVerifyActivateAndDeactivatePaymentMethodFeesActivationToggle(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            Pages.AdminSystemMangement.VerifyActivateAndDeactivatePaymentMethodFeesActivationStatusToggle(testdatamap,Log);       	
