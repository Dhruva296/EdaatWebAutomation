  /**
* Test Script Name                   : AdminApprovedBillersMgmAddSamePaymentMethodForMoreThanOneBiller
...
public class AdminApprovedBillersMgmAddSamePaymentMethodForMoreThanOneBiller {
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminApprovedBillersMgmAddSamePaymentMethodForMoreThanOneBiller(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminNotApprovedBillerManagement.verifyAssignAllThePaymentMethods(testdatamap,Log);
