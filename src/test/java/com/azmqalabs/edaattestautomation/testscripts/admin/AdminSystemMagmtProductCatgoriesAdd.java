/**
*
* Test Script Name                   : AdminSystemMagmtProductCatgoriesAdd
* Test Data Sheet Name				 : AdminAddCategory
* Objective                          : Verify to add new product under System Management module
* Version                            : 1.0
...
public void myTest() throws InterruptedException, Exception{
    try{
    	...
    	Pages.AdminSystemMangement.AddCategory(testdatamap,Log);
