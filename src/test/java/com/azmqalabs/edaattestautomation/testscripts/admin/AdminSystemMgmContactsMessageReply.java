/**
*
* Test Script Name                   : AdminSystemMgmContactsMessageReply 
* Test data sheet Name               : AdminSystemMgmContactsMsgReply
* Objective                          : Verify Message Details & Reply Under System Management module
* Version                            : 1.0
...
* Pre-Conditions                     : 1)Valid Admin login credentials 
                                       2)Sender Details should be present.
* Epic Details                       : N/A
...
public class AdminSystemMgmContactsMessageReply {

	// DECLARATION SECTION
	static String TestDataTab="AdminSystemMgmContactsMsgReply";  
	...
	public AdminSystemMgmContactsMessageReply(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSystemMangementContactsPage.navigateContactsManagement(Log);
			
			Pages.AdminSystemMangementContactsPage.MessageReplyDetails(testdatamap,Log);
