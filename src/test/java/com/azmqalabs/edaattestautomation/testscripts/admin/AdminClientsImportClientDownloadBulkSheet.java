/**
*
* Test Script Name                   : AdminClientsImportClientDownloadBulkSheet
* Test Data Sheet                    : AdminImportsClientDataBulkSheet
...
public class AdminClientsImportClientDownloadBulkSheet {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminImportsClientDataBulkSheet";
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminClientsImportClientDownloadBulkSheet(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminClientsImportClientDataPage.VerifyDownloadBulkSheet(testdatamap,Log);
