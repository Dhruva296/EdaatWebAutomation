/**
*
* Test Script Name                   : AdminNotApprovedBillersMgmVerifyAvailablePaymentMethod
* Test Data Sheet Name				 : AdminVerifyAvailPaymentMethod
* Objective                          : 1)Verify the Available Payment Methods Under system management module
* 									 : 2)Verify the available payment methods list are checkbox Under system management module
* Version                            : 1.0
...
public class AdminNotApprovedBillersMgmVerifyAvailablePaymentMethod {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminVerifyAvailPaymentMethod";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminNotApprovedBillersMgmVerifyAvailablePaymentMethod(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminNotApprovedBillerManagement.verifyAvailablePaymentMethodsIsDisplayed(Log);
	        	
	        	Pages.AdminNotApprovedBillerManagement.verifyAvailablePaymentMethodsIsDisplayedWithCheckboxes(Log);
