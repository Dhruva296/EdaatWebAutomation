/**
*
* Test Script Name                   : AdminSystemMgmPaymentMethodEditFees 
* Test data sheet Name               : AdminPaymentMethodEditFees
* Objective                          : [Admin] Verify to Edit Fees in the Payment Methods Management page
* Version                            : 1.0
...
public class AdminSystemMgmPaymentMethodEditFees {

	// DECLARATION SECTION
	static String TestDataTab="AdminPaymentMethodEditFees";  
	...
	public AdminSystemMgmPaymentMethodEditFees(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSystemMangement.verifyEditFeesInPaymentMethodPage(testdatamap,Log);
