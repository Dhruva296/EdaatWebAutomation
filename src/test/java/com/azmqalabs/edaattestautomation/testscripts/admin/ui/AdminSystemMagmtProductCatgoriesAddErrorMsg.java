/**
* Test Script Name                   : AdminSystemMagmtProductCatgoriesAddErrorMsg
* Test Data Sheet Name				 : AdminAddCategory
* Objective                          : Verify add product Category Error Messages under System Management module
* Version                            : 1.0
...
* Pre-Conditions                     : 1)Valid Admin login credentials 
									 : 2)Category details should be present.
* Epic Details                       : N/A
...
public class AdminSystemMagmtProductCatgoriesAddErrorMsg{
...
public AdminSystemMagmtProductCatgoriesAddErrorMsg(Map<Object, Object> testdatamap){
...
public void myTest() throws InterruptedException, Exception{
    try{
    	...
    	Pages.AdminSystemMangement.navigateSystemMangementProductCategory(Log);
    	
    	Pages.AdminSystemMangement.AddCategoryErrorMsg(testdatamap,Log);
