/**
*
* Test Script Name                   : AdminSystemMgmIndividualClientAccountSettingButtonErrorMsg 
...
public class AdminSystemMgmIndividualClientAccountSettingButtonErrorMsg {
	...
	public AdminSystemMgmIndividualClientAccountSettingButtonErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSystemMgmIndividualClientPage.VerifyAccountSettingButtonErrorMsg(testdatamap,Log);
