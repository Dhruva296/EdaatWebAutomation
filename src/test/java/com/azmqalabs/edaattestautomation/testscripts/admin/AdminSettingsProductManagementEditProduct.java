/**
* Test Script Name                   : AdminSettingsProductManagementEditProduct
* TestData Sheet Name                : AdminUpdateProducts
* Objective                          : Verify Edit product button
* Version                            : 1.0
* Author                             : Kathirvelu M
	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsPage.navigateProduct(Log);
	        	
	        	Pages.AdminSettingsPage.UpadateProduct(testdatamap,Log);
