/**
* Test Script Name                   : AdminSettingsProductManagementAddInActivate
* TestData Sheet Name                : AdminInActiveProduct
* Objective                          : Verify to add product & De-Activate
* Version                            : 1.0
* Author                             : Kathirvelu M
	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsPage.verifyDeActiveProductFunctionality(testdatamap,Log);
