/**
*
* Test Script Name                   : AdminSettingsDiscountManagementStatusToggle 
* Test data sheet Name               : AdminSettingsDisMgmStatusToggle
* Objective                          : Verify status toggel
* Version                            : 1.0
...
* Pre-Conditions                     : 1)Admin login credentials 
                                       2)Discount details should be present                                 
* Epic Details                       : N/A
...
public class AdminSettingsDiscountManagementStatusToggle {

	// DECLARATION SECTION
	static String TestDataTab="AdminSettingsDisMgmStatusToggle";  
	...
	public AdminSettingsDiscountManagementStatusToggle(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSettingsDiscountPage.navigateDisCountPage(Log);
			
			Pages.AdminSettingsDiscountPage.StatusToggle(testdatamap,Log);
