/**
* Test Script Name                   : AdminSystemMngSamaIntegrationHistroyVerify
* Test Data Sheet Name				 : AdminSamaIntegrationHistory
* Objective                          : Verify History Of  Precautionary Data Sent To SAMA under System Management module
* Version                            : 1.0
...
public class AdminSystemMngSamaIntegrationHistroyVerify{
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSamaIntegrationHistory";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMngSamaIntegrationHistroyVerify(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemManagementSamaIntegrationPage.navigateSamaIntegrationAndHistoryOfPaymentsReturns(Log);
	        	
	        	Pages.AdminSystemManagementSamaIntegrationPage.VerifyHistoryofPaymentReturns(testdatamap,Log);
