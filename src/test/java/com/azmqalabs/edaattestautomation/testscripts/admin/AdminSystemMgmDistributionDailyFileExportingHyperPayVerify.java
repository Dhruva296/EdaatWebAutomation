/**
*
* Test Script Name                   : AdminSystemMgmDistributionDailyFileExportingHyperPayVerify.
* Test Data Sheet                    : AdminSysMgmDistDailyFileExport
* Objective                          : [Admin]Verify Add new page Daily file exporting [Hyper pay] 
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminSystemMgmDistributionDailyFileExportingHyperPayVerify {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSysMgmDistDailyFileExport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMgmDistributionDailyFileExportingHyperPayVerify(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMngDistributionPage.VerifyDailyFileExportingHyperPay(Log);
