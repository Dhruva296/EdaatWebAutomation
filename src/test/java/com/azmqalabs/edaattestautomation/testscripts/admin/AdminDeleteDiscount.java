/**
* Test Script Name  				 : AdminDeleteDiscount
* TestDataSheet                      : AdminDiscountDelete
* Objective     					 : To Verify to delete the discount under settings module
* Version      						 : 1.0
...
public class AdminDeleteDiscount {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminDeleteDiscount";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminDeleteDiscount(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsDiscountPage.verifyDeleteDiscount(testdatamap,Log);
