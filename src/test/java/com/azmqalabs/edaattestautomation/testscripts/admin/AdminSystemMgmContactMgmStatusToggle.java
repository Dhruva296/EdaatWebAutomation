/**
*
* Test Script Name                   : AdminSystemMgmContactMgmStatusToggle.
* TestData sheet Name                : AdminContactsMgmStatusToggle
* Objective                          : Verify the status toggel Under System Management module
* Version                            : 1.0
...
public class AdminSystemMgmContactMgmStatusToggle {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminContactsMgmStatusToggle";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMgmContactMgmStatusToggle(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMangementContactsPage.VerifyStatusToggle(testdatamap,Log);
