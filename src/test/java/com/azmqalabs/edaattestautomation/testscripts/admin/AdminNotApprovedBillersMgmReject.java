/**
* Test Script Name                   : AdminNotApprovedBillersMgmReject
* Test Data Sheet Name				 : AdmNotApprBilMgmReject
* Objective                          : 1)Verify to Reject the biller activation account by checker under system management module
*  									 : 2)Verify to click on close button withoud doing any action by checker
* Version                            : 1.0
	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminNotApprovedBillerManagement.VerifyBillerApprovalIsRejected(testdatamap,Log);
	        	
	        	Pages.AdminNotApprovedBillerManagement.VerifyBillerApprovalIsClosed(testdatamap,Log);
