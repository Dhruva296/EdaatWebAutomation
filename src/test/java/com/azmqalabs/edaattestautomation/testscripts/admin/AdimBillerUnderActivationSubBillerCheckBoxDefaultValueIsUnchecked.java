...
public class AdimBillerUnderActivationSubBillerCheckBoxDefaultValueIsUnchecked {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdmBillUndActSubDefaultChkBox";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdimBillerUnderActivationSubBillerCheckBoxDefaultValueIsUnchecked(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminNotApprovedBillerManagement.verifySubBillerCheckBox(testdatamap,Log);
