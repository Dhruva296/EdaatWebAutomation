/**
*
* Test Script Name                   : AdminReportsPaymentTransactionAndOperationFeesReport 
* Test data sheet Name               : AdminReportsPaymentTransaction
* Objective                          : Verify Payment Transactions & Operation Fees Report
* Version                            : 1.0
...
public class AdminReportsPaymentTransactionAndOperationFeesReport {

	// DECLARATION SECTION
	static String TestDataTab="AdminReportsPaymentTransaction";  
	...
	public AdminReportsPaymentTransactionAndOperationFeesReport(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminReportsAdminReportsPage.VerifyPaymentTransactionsReport(testdatamap,Log);
