/**
* Test Script Name  				 : AdminReceivableReportIndividualClientReport
* TestData sheet Name                : AdminReceivableIndClientReport
* Objective     					 : Verify Individual Clients Report Under Reports Module
* Version      						 : 1.0
...
public class AdminReceivableReportIndividualClientReport {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReceivableIndClientReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReceivableReportIndividualClientReport(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReportsReceivablesReportsPage.VerifyIndividualClientsReport(testdatamap,Log);
