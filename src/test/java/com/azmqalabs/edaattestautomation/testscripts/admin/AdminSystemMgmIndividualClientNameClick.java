/**
*
* Test Script Name                   : AdminSystemMgmIndividualClientNameClick 
* Test data sheet Name               : AdminSysMgmNameClick
* Objective                          : Verify that the Client name is clickable under system management module
* Version                            : 1.0
...
public class AdminSystemMgmIndividualClientNameClick {

	// DECLARATION SECTION
	static String TestDataTab="AdminSysMgmIndNameClick";  
	...
	public AdminSystemMgmIndividualClientNameClick(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSystemMgmIndividualClientPage.ClientNameClickable(testdatamap,Log);
