/**
* Test Script Name                   : AdminReportClientAccountStatement
* Test Data Sheet                    : AdminReportClientAccountstm
* Objective                          : Verify to Generate client account Statement report Under Reports Module
* Version                            : 1.0
...
public class AdminReportClientAccountStatement{
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReportClientAccountstm";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReportClientAccountStatement(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
		        ...
		        Pages.AdminReportsReceivablesReportsPage.navigatetoclientAccountStatement(Log);
	        
	        	Pages.AdminReportsReceivablesReportsPage.ClientAccountReports(testdatamap,Log);
