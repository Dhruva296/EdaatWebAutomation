/**
*
* Test Script Name                   : AdminNotApprovedBillersMgmVerifyAddMiniInvoiceAmountCheckbox
* Test Data Sheet Name				 : AdminVerifyaddMiniInvoiceAmount
* Objective                          : Verify To add minimum invoice amount
* Version                            : 1.0
...
public class AdminNotApprovedBillersMgmVerifyAddMiniInvoiceAmountCheckbox {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminVerifyaddMiniInvoiceAmount";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminNotApprovedBillersMgmVerifyAddMiniInvoiceAmountCheckbox(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminNotApprovedBillerManagement.verifyAddMinimumInvoiceAmountCheckbox(Log);
