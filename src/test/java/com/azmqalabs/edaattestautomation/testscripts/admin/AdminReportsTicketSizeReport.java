 /**
* Test Script Name                   : AdminReportsTicketSizeReport.
* TestData sheet Name                : AdminReportsTicketSize.
* Objective                          : Verify to generate Ticket Size Report under Admin Reports.
* Version                            : 1.0
...
public class AdminReportsTicketSizeReport {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReportsTicketSize";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReportsTicketSizeReport(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReportsAdminReportsPage.TicketSizeReport(testdatamap,Log);
