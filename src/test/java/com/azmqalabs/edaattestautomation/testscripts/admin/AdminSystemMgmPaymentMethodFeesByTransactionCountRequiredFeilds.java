/**
*
* Test Script Name                   : AdminSystemMgmPaymentMethodFeesByTransactionCountRequiredFeilds 
* Test data sheet Name               : AdminFeesByTransactionReqFields
* Objective                          : [Admin] Verify to add Fees based on number of transaction in payment method page
* Version                            : 1.0
...
public class AdminSystemMgmPaymentMethodFeesByTransactionCountRequiredFeilds {

	// DECLARATION SECTION
	static String TestDataTab="AdminFeesByTransactionReqFields";  
	...
	public AdminSystemMgmPaymentMethodFeesByTransactionCountRequiredFeilds(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSystemMangement.VerifyPaymentMethodsAddFeesBasedOnInvoiceOrTransaction(testdatamap,Log);
