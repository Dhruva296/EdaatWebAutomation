/**
*
* Test Script Name                   : AdminSystemMgmPaymentProvidersMgmGridViewDetails 
* Test data sheet Name               : AdminPaymentProviderMgmGridView
* Objective                          : Verify the grid view for the Payment providers Management page under System Management module
* Version                            : 1.0
...
public class AdminSystemMgmPaymentProvidersMgmGridViewDetails {

	// DECLARATION SECTION
	static String TestDataTab="AdminPaymentProviderMgmGridView";  
	...
	public AdminSystemMgmPaymentProvidersMgmGridViewDetails(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSystemMangement.navigatePaymentProviderManagement(Log);

			Pages.AdminSystemMangement.verifyPaymentProvidersManagementGridViewDetails(testdatamap,Log);
