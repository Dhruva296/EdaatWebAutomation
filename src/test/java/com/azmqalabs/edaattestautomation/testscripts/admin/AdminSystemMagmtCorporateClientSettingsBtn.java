/**
*
* Test Script Name                   : AdminSystemMagmtCorporateClientSettingsBtn.
* TestData Sheet Name                : AdminSysMgmCorpClientSettings
* Objective                          : Verify Account Setting button [Suspended,Suspended Permanently]  under system management module
* Version                            : 1.0
...
public class AdminSystemMagmtCorporateClientSettingsBtn{
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSysMgmCorpClientSettings";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMagmtCorporateClientSettingsBtn(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMngCorporateclientMngpage.CorporateClientSettingsBtn(testdatamap,Log);
