/**
*
* Test Script Name                   : AdminNotApprovedBillersMgmVerifyDefaultPaymentIsSelectedAndDisabled
* Test Data Sheet Name				 : AdminVrfyDefaultPayMtIsSelected
* Objective                          : Verify the default payment method is selected and disabled
* Version                            : 1.0
...
public class AdminNotApprovedBillersMgmVerifyDefaultPaymentIsSelectedAndDisabled {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminVrfyDefaultPayMtIsSelected";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminNotApprovedBillersMgmVerifyDefaultPaymentIsSelectedAndDisabled(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminNotApprovedBillerManagement.verifyDefaultPaymentIsSelectedAndDisabled(Log);
