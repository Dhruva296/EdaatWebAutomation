/**
* Test Script Name                   : AdminReceivableReportsVerifyClientInvoiceReport
* TestData Sheet Name                : AdminRCVClientInvoiceReport
* Objective                          : Verify Clients Invoices Report under Reporst module.
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminReceivableReportsVerifyClientInvoiceReport {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminRCVClientInvoiceReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReceivableReportsVerifyClientInvoiceReport(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReportsReceivablesReportsPage.ReceivableReportsClientInvoice(testdatamap,Log);
