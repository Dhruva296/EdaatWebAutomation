/**
*
* Test Script Name                   : AdminImportClientdataType.
* Test Data Sheet                    : AdminImportclientdata.
* Objective                          : Verify to Select Client Type in 
*                                      Import client data under Clients Module.
* Version                            : 1.0
...
public class AdminImportClientdataType {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminImportclientdata";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminImportClientdataType(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminClientsImportClientDataPage.VerifyClienttype(testdatamap,Log);
