/**
*
* Test Script Name                   : AdminSystemMgmIndividualClientStatustoggle 
* Test data sheet Name               : AdminIndividualClientStatustoggle
* Objective                          : Verify the status toggle under System Management Module
* Version                            : 1.0
* Author                             : Kathirvelu Mohan
* Created Date                       : 23/05/2023
* Last Updated on                    : N/A
* Updated By                         : Basavaraj M M
* Pre-Conditions                     : 1)Valid Admin login credentials 
                                       2)Individual Client should be created.
* Epic Details                       : N/A
...
public class AdminSystemMgmIndividualClientStatustoggle {

	// DECLARATION SECTION
	static String TestDataTab="AdminSysIndlClientStatustoggle";  
	...
	public AdminSystemMgmIndividualClientStatustoggle(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSystemMgmIndividualClientPage.IndividualClientActivationAndDeactivation(testdatamap,Log);
