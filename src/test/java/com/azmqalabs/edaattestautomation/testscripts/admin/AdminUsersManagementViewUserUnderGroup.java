/**
* Test Script Name                   : AdminUsersManagementViewUserUnderGroup
* TestData Sheet Name                : AdminUserMgmViewUser
* Objective                          : Verify to view the users under this group under user management module
* Version                            : 1.0
...
*                                      2)User should be present under Group
* Epic Details                       : N/A
...
public class AdminUsersManagementViewUserUnderGroup {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminUserMgmViewUser";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUsersManagementViewUserUnderGroup(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngGrpsMngPage.ViewUsersUnderGroup(testdatamap,Log);
