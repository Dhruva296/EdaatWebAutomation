/**
*
* Test Script Name                   : AdminSettingsTermsManagementsGridView
* Test Data Sheet                    : AdminSettingsTermsMgmGridView
...
public class AdminSettingsTermsManagementsGridView{
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSettingsTermsMgmGridView";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsTermsManagementsGridView(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingTermsManagementPage.VerifyGridView(Log);
