/**
*
* Test Script Name                   : AdminUserListUserNameClick
* Test data sheet Name               : AdminUserNameClickable
* Objective                          : Verify the user name is clickable under usermanagement module
* Version                            : 1.0
...
public class AdminUserListUserNameClick {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminUserNameClickable";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUserListUserNameClick(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngUserListPage.verifyUsernameClikable(testdatamap,Log);
