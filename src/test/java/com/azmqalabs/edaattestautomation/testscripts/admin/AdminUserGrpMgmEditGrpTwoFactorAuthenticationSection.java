/**
* Test Script Name                   : AdminUserGrpMgmEditGrpPermissionTwoFactorAuthenticationSection
* Test Data Sheet Name				 : AdminUserGroupMgmEditTwoFactor
* Objective                          : Verify admin can edit the 2-factor authentication section/setting any time under Management module
* Version                            : 1.0
...
public class AdminUserGrpMgmEditGrpTwoFactorAuthenticationSection {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminUserGroupMgmEditTwoFactor";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUserGrpMgmEditGrpTwoFactorAuthenticationSection(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngGrpsMngPage.verifyEditGroupTwoFactorAuthentication(testdatamap,Log);
