/**
*
* Test Script Name                   : AdminUserGrpMgmviewpermision
* Test Data Sheet                    : AdminUserGroupMgmView
* Objective                          : Verify the view eye icon button is Clickable under User Management module                                 
* Version                            : 1.0
...
public class AdminUserGrpMgmviewpermision {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminUserGroupMgmView";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUserGrpMgmviewpermision(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngGrpsMngPage.Viewpermision(testdatamap,Log);
