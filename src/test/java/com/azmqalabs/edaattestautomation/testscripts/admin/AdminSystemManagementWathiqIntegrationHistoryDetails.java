/**
* Test Script Name                   : AdminSystemManagementWathiqIntegrationHistoryDetails
* TestData Sheet Name                : AdminSystemMgmWathiqCRCheck
* Objective                          : Verify CR Check
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminSystemManagementWathiqIntegrationHistoryDetails {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSystemMgmWathiqHistory";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemManagementWathiqIntegrationHistoryDetails(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemManagementWathiqIntegrationPage.NavigateWathiqIntegrationHistory(Log);
	        	
	        	Pages.AdminSystemManagementWathiqIntegrationPage.WathiqIntegrationHistoryDetails(testdatamap,Log);
