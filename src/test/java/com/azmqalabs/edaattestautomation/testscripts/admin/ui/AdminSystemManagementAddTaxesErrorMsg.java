/**
*
* Test case Script Name              :AdminSystemManagementAddTaxesErrorMsg
* Test Data Sheet Name				 :AdminAddTax
* Objective                          :Verify Add Tax Error Messages under System Management module
* Version                            :1.0
...
* Pre-Conditions                     :1)Valid Admin login credentials 
									 :2)Tax details should be present
* Epic Details                       :N/A
...
public class AdminSystemManagementAddTaxesErrorMsg {
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemManagementAddTaxesErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMangement.navigateSystemMangementTax(Log);
	        	
	         	Pages.AdminSystemMangement.AddTaxErrorMsg(testdatamap,Log);
