/**
* Test Script Name                   : AdminUserGrpMgmEditGrpPermission
* Test Data Sheet Name				 : AdminUserGroupMgmEditpermission
* Objective                          : Verify to edit group permission under Management module
* Version                            : 1.0
...
public class AdminUserGrpMgmEditGrpPermission {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminUserGroupMgmEditpermission";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUserGrpMgmEditGrpPermission(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngGrpsMngPage.EditGroupPermission(testdatamap,Log);
