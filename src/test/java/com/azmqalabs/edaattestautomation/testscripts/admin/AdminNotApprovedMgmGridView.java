/**
* Test Script Name                   : AdminNotApprovedMgmGridView
* Test Data Sheet Name				 : AdmNotApprBilMgmGrid
* Objective                          : Verify Grid details view under System Management module
* Version                            : 1.0
...
public class AdminNotApprovedMgmGridView {
	...
	// DECLARATION SECTION
	static String TestDataTab="AdmNotApprBilMgmGrid";  
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminNotApprovedBillerManagement.VerifyBillersUnderActivationGridView(testdatamap,Log);
