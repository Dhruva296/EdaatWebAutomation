/**
* Test Script Name                   : AdminSystemMgmDistributionRecord.
* Test Data Sheet                    : AdminSysMngDistRecordPosting.
* Objective                          : Verify to view Distribution Record of Posting under system management module
* Version                            : 1.0
* Author                             : Kathirvelu Mohan
* Created Date                       : 23/05/2023
* Last Updated on                    : N/A
* Updated By                         : Arun Kumar M S
* Pre-Conditions                     : 1)Valid login Admin Credentials. 2)Record of Posting.
* Epic Details                       : N/A
...
public class AdminSystemMgmDistributionRecord {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSysMngDistRecordPosting";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMgmDistributionRecord(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMngDistributionPage.NavigateToDistributionRecordOfPosting(Log);
	        	
	        	Pages.AdminSystemMngDistributionPage.VerifyRecordofpostingview(testdatamap,Log);
