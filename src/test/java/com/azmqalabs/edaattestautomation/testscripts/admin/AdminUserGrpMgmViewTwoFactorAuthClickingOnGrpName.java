/**
*
* Test Script Name                   : AdminUserGrpMgmViewTwoFactorAuthClickingOnGrpName
* Test Data Sheet Name				 : AdminUsrGrpMgmTwoFactAutGrpName
* Objective                          : Verify that the view two factor authentication.
* Version                            : 1.0
...
public class AdminUserGrpMgmViewTwoFactorAuthClickingOnGrpName {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminUsrGrpMgmTwoFactAutGrpName";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUserGrpMgmViewTwoFactorAuthClickingOnGrpName(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngGrpsMngPage.ViewTwoFactorAuthenticationClickingOnGroupName(testdatamap,Log);
