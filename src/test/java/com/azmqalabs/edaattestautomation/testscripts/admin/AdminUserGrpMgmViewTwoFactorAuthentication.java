/**
*
* Test Script Name                   : AdminUserGrpMgmViewTwoFactorAuthentication
* Test Data Sheet Name				 : AdminUserGroupMgmVfyTwoFactAuth
* Objective                          : Verify that view two factor authentication under Users Management module
* Version                            : 1.0
...
public class AdminUserGrpMgmViewTwoFactorAuthentication {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminUserGroupMgmVfyTwoFactAuth";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUserGrpMgmViewTwoFactorAuthentication(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngGrpsMngPage.ViewTwoFactorAuthentication(testdatamap,Log);
