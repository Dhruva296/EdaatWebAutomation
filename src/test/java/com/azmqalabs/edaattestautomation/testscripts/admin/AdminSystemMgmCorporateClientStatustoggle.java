/**
*
* Test Script Name                   : AdminSystemMgmCorporateClientStatustoggle.
* Test Data Sheet                    : AdminCorporateClientStatustoggl
* Objective                          : Verify the Corporate client status toggle under System Management.
* Version                            : 1.0
* Author                             : Kathirvelu Mohan
* Created Date                       : 23/05/2023
* Last Updated on                    : N/A
* Updated By                         : Dhruva Kumar S
* Pre-Conditions                     : 1)Valid login Admin Credentials 2)Corporate client should be present.
* Epic Details                       : N/A
...
import com.azmqalabs.edaattestautomation.apppages.admin.pages.AdminSystemMngCorporateclientMngpage;
...
public class AdminSystemMgmCorporateClientStatustoggle {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminCorporateClientStatustoggl";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMgmCorporateClientStatustoggle(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMngCorporateclientMngpage.NavigatetoCorporateClientsMng(Log);
	        	
	        	Pages.AdminSystemMngCorporateclientMngpage.carporateClientSearch(testdatamap, Log);   
	        	
	        	Pages.AdminSystemMngCorporateclientMngpage.CorporateClientStatustoggle(testdatamap,Log);       	
