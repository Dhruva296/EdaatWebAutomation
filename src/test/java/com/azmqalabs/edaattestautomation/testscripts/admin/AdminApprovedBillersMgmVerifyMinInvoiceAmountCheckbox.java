/**
* Test Script Name                   : AdminApprovedBillersMgmVerifyMinInvoiceAmountCheckbox
* Test data sheet Name               : AdminMinAmountCheckbox			
* Objective                          : Verify that when admin check the check box a textbox is viewed to enter minimum value
* Version                            : 1.0
...
public class AdminApprovedBillersMgmVerifyMinInvoiceAmountCheckbox {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminMinAmountCheckbox";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminApprovedBillersMgmVerifyMinInvoiceAmountCheckbox(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminApprovedBillerManagement.checkMinInvoiceAmountCheckbox(testdatamap,Log);
