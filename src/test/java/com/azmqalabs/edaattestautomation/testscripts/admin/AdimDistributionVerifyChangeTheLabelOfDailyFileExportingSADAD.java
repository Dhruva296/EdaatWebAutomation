...
public class AdimDistributionVerifyChangeTheLabelOfDailyFileExportingSADAD {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminDailyFileExportLabelSADAD";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdimDistributionVerifyChangeTheLabelOfDailyFileExportingSADAD(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMngDistributionPage.verifyDailyFileExportingSADADPage(testdatamap,Log);
