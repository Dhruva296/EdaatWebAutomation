...
public class AdminClientsEditIndividualClientErrorMsg {
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminIndividualClientPage.navigateToIndividualClientsList(Log);
			
			Pages.AdminIndividualClientPage.VerifyEditIndClietErrorMsg(FullName,SecondName,ThirdName,LastName,NationalID,Year,Month,Date,MobileNo,Email,Refno,ExpectedResult,Log);
