...
public class ClientPayablesIncomingBillsBillNumberClick {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientPayIncomingBillNumClick";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientPayablesIncomingBillsBillNumberClick(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.ClientPayablesIncomingBillsPage.VerifyBillNumberClickable(testdatamap,Log);
