...
public class AdminSignUpPage extends BasePage
{
	...
	public void EnterAdminCompanyName(String CompName) throws Exception{
	...
	public void EnterAdminEmplyMobileNum(String EmplyMob) throws Exception{
	...
	public void EnterAdminEmplyEmail(String EmplyEmail)throws Exception {
	...
	public void EnterAdminCustomerSupPhNo(String CustomerSupPhNo)throws Exception {
	...
	public void EnterAdminIBANum(String IBANum) throws Exception{
	...
	//Parameter Summary  : N/A
	public void EnterAdminExperyDate(String ExperyDate) throws Exception {
	...
	public void EnterAdminTaxno(String Taxno)throws Exception {
	...
	public void EnterAdminFirstName(String FirstName)throws Exception {
		WebEdit(EdaatOR.Admin_FirstName_eField,FirstName);
	}
	//Function Summary   : Method to EnterAdminSurName
	//Parameter Summary  : Surname

	public void EnterAdminSurName(String SurName) throws Exception{
	...
	public void EnterAdminGradFatherName(String GradFatherName) throws Exception{
	...
	public void EnterAdminLastName(String LastName) throws Exception{
		WebEdit(EdaatOR.Admin_LastName_eField,LastName);
	}
	//Function Summary   : Method to EnterAdminNationalID
	//Parameter Summary  : LastName
	public void EnterAdminNationalID(String NationalID_)throws Exception {
	...
	public void EnterAdminAuthLterTemltAttmnt(String AuthLterTemltAttmnt)throws Exception {
	...
	public void EnterAdminCommisionPhNo(String CommisionPhNo) throws Exception {
	...
	public void EnterAdminCommisionEmail(String CommisionEmail) throws Exception {
	...
	public void EnterAdminUserID(String UserID) throws Exception {
	...
	public void EnterAdminConfPawd(String ConfPawd)throws Exception {
